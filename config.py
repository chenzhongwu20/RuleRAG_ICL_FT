...
def parse_args():
    ...
    parser.add_argument("--MICRO_BATCH_SIZE", type=int, default=1, help="Per device train batch size")
    parser.add_argument("--BATCH_SIZE", type=int, default=2, help="batch size")
    parser.add_argument('--EPOCHS', type=int, default=5, help='Training epochs')
    parser.add_argument('--WARMUP_STEPS', type=int, default=100, help='Warmup steps')
    parser.add_argument('--LEARNING_RATE', type=float, default= 3e-4 , help='Training learning rate')
    parser.add_argument('--CONTEXT_LEN', type=int, default=1000, help='Truncation length of context (in json)')
    parser.add_argument('--TARGET_LEN', type=int, default=36, help='Truncation length of target (in json)')
    parser.add_argument('--TEXT_LEN', type=int, default=256, help='Truncation length of text (in txt)')
    parser.add_argument('--LORA_R', type=int, default=4, help='Lora low rank')
    parser.add_argument('--LORA_ALPHA', type=int, default=16, help='Lora Alpha')
    parser.add_argument('--LORA_DROPOUT', type=float, default=0.05, help='Lora dropout')
    parser.add_argument('--MODEL_NAME', type=str, default="", help='Model name')
    parser.add_argument('--LOGGING_STEPS', type=int, default=10, help='Logging steps in training')
    ...
    parser.add_argument('--DATA_PATH', type=str, default="", help='Input dir of trainset')
